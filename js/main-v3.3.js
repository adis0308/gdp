                        ...
                        },
                        {
                            ...
                            render: function (value, type, row, meta) {
                                if (row.id !== "") {
                                    ...
                                    html += '<button type="button" class="dropdown-item delete" data-id="' + value.id + '" data-name="' + row.title + " - " + row.desc + '"><i class="fas fa-trash mr-2"></i>Delete</button>';
                                    if ("type" in row.mimeType && row.mimeType.type.indexOf(".folder") === -1) {
            ...
            $("#tbGDBackupQueue").DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        responsivePriority: 2,
                        render: function (value, type, row) {
                            return '<button data-id="' + value + '" data-name="' + row.gdrive_id + '" data-toggle="tooltip" title="Delete" type="button" class="btn btn-danger btn-sm delete"><i class="fas fa-trash-alt"></i></button>';
                        },
                    },
                ],
                columnDefs: [
